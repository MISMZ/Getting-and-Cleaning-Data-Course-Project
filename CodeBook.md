## Tidy data output (tidy_data.csv) has 89 columns (86 variables which contains mean and standard deviation for the measurement + subject label + activity label + dataset label) and 10,299 observation rows
